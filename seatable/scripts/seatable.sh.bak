...
function set_env() {
    ...
    export HOME=/root
    export SEATABLE_DONT_CHECK_USER_NUMBER_ON_ADD=${SEATABLE_DONT_CHECK_USER_NUMBER_ON_ADD:-false}
    export STORAGE_SERVER_ENABLE_SNAPSHOT_CLEANUP=${STORAGE_SERVER_ENABLE_SNAPSHOT_CLEANUP:-true}
}
